...
var player = {
  ...
  replayevent: function replayevent() {
    player.ruintimer();
    player.i = 1;
    player.playStart();
  },
  slowevent: function slowevent() {
    player.ruintimer();
    player.setTime = 30;
    player.playStart();
  },
  middleevent: function middleevent() {
    player.ruintimer();
    player.setTime = 15;
    player.playStart();
  },
  fastevent: function fastevent() {
    player.ruintimer();
    player.setTime = 5;
    player.playStart();
  }
